...
abstract class BaseListView extends Widget
{
    ...
    public $options = [];
    /**
     * @var \zacksleo\laravel\yii\data\ActiveDataProvider the data provider for the view. This property is required.
     */
    public $dataProvider;
    /**
    ...
    public function init()
    {
        ...
        if ($this->emptyText === null) {
            $this->emptyText = __('yii.No results found.');
        }
    ...
    public function renderSummary()
    {
        ...
        if (($pagination = $this->dataProvider->getPagination()) !== false) {
            ...
            if (($summaryContent = $this->summary) === null) {
                return Html::tag($tag, __('yii.Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.', [
                        'begin' => $begin,
                        'end' => $end,
                        'count' => $count,
            ...
            if (($summaryContent = $this->summary) === null) {
                return Html::tag($tag, __('yii.Total <b>{count, number}</b> {count, plural, one{item} other{items}}.', [
                    'begin' => $begin,
                    'end' => $end,
                    'count' => $count,
                    'totalCount' => $totalCount,
