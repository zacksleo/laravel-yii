...
namespace zacksleo\laravel\yii\base;

use InvalidArgumentException;
use InvalidArgumentException as UnknownMethodException;
use InvalidArgumentException as InvalidCallException;
use InvalidArgumentException as UnknownPropertyException;
use zacksleo\laravel\Yii as Yii;
...
class Component extends BaseObject
{
     ...
     * @throws InvalidArgumentException if the property is read-only.
     * @see __get()
     */
