...
class Html
{
    ...
    public static function a($text, $url = null, $options = [])
    {
        if ($url !== null) {
            if (is_array($url)) {
                $options['href'] = url(array_shift($url), $url);
            } else {
    ...
    public static function activeLabel($model, $attribute, $options = [])
    {
        ...
        $label = ArrayHelper::remove($options, 'label', static::encode(ucfirst($attribute)));
    ...
    {
        $header = isset($options['header']) ? $options['header'] : '<p>' . Yii::t('yii',
        ...
        if (empty($lines)) {
            ...
            $content = '<ul></ul>';
            $options['style'] = isset($options['style']) ? rtrim($options['style'],
    ...
    protected static function activeBooleanInput($type, $model, $attribute, $options = [])
    {
        ...
        if (!array_key_exists('label', $options)) {
            $options['label'] = static::encode(ucfirst(static::getAttributeName($attribute)));
