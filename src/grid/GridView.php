...
use zacksleo\laravel\yii\widgets\BaseListView;
...
class GridView extends BaseListView
{
    ...
    {
        $filterUrl = isset($this->filterUrl) ? $this->filterUrl : url()->current();
    ...
    {
        $models = array_values($this->dataProvider->getModels()->toArray());
