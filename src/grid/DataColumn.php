...
use zacksleo\laravel\yii\data\ActiveDataProvider;
use zacksleo\laravel\yii\data\ArrayDataProvider;
        ...
        if ($this->label === null) {
            if ($provider instanceof ActiveDataProvider && $provider->query instanceof ActiveQueryInterface) {
                ...
                if (($model = reset($models)) instanceof Model) {
                    ...
                    $label = str_replace(' ', '', ucwords(preg_replace('/[^A-Za-z0-9]+/', ' ', $this->attribute)));
                }
            }
        } else {
            $label = $this->label;
